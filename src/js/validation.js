...
let footer_button = document.querySelector(".footer__bottom-post-button");
let form = document.querySelector(".footer__bottom-post-transmission");
let footer_input = document.querySelector(".footer__bottom-post-input");
